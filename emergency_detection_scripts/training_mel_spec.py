...
class Train_Mel_Spec:
    ...
    def __load_audio_data(self):
        ...
        for file in self.__read_wav_files(ambulance_path):
            audio_files.append(file)
            labels.append("Emergency Vehicle")

        print("Reading files : firetruck")
        for file in self.__read_wav_files(firetruck_path):
            audio_files.append(file)
            labels.append("Emergency Vehicle")

        #regular traffic labels
        print("Reading files : traffic")
        for file in self.__read_wav_files(traffic_path):
            audio_files.append(file)
    ...
    def __read_wav_files(self,path):
        temp_audio_files = []
    ...
    def train_model(self):
        ...
        audio_files, labels = self.__load_audio_data()
